  ...
  function render(){
    ...
    if (banner){
      banner.innerHTML = (type === 'poster')
        ? 'You have been selected for <strong>Poster Presentation</strong>. Please upload your poster file below.'
        : 'You have been selected for <strong>Oral Presentation</strong>. Please upload your presentation slides below.';
    }
